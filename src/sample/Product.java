...
public class Product implements Comparable<Product> {
    ...
    Product(String name , double price ){
        ...
        ImageView imageView = new ImageView(image);
         ...
         ConfermationStage confermationStage = new ConfermationStage("Are You Sure You Want To Delete This Prodcut?", "هل انت متاكد انك تريد مسح هذا منتج ؟", 
                e->{
                    Main.sync(this);
        ...
        count.textProperty().addListener(e->{
            ...
            if(amount == 0 && order != null) {
                order.deleteOrderNode(this.name);
        ...
        deleteButton.setOnAction(e->confermationStage.show());
